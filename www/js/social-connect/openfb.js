...
var openFB = (function () {
    ...
    var FB_LOGIN_URL = 'https://www.facebook.com/dialog/oauth',
		...
		// By default we store fbtoken_hp in sessionStorage. This can be overridden in init()
    ...
    function getLoginStatus(callback) {
        var token = tokenStore['fbtoken_hp'],
                loginStatus = {};
		console.log(token);
        if (token) {
...
//            oauthRedirectURL = "https://www.facebook.com/connect/login_success.html";
    ...
    function oauthCallback(url) {
        ...
        if (url.indexOf("access_token=") > 0) {
            ...
            tokenStore['fbtoken_hp'] = obj['access_token'];
            if (loginCallback)
    ...
    function logout(callback) {
        var logoutWindow,
                token = tokenStore['fbtoken_hp'];

//        /* Remove token. Will fail silently if does not exist */
//        tokenStore.removeItem('fbtoken_hp');
...
//        }
    ...
    function api(obj) {
        ...
        params['access_token'] = tokenStore['fbtoken_hp'];
    ...
    function revokePermissions(success, error) {
        return api({method: 'DELETE',
            path: '/me/permissions',
            success: function () {
                tokenStore['fbtoken_hp'] = undefined;
                success();
            },
            error: error});
    }
